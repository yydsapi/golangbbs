  ...
  var Main = {
    ...
    data() { 
        try{    
          return {
            filterText: '',
            data: JSON.parse({{.Content}})[0].children,
            defaultProps: {
            children: 'children',
            label: 'name'
            //id: 'id'
    ...
    methods: {
      append(data) {
        const newChild = { en: "en", label: 'testtest', children: [] };
        if (!data.children) {
        ...
        children.splice(index, 1);
            ...
            additem() {
                  ...
                  setTimeout(function(){
                    ...
                    dg3.$set(dg3.commonForm,'pid', "root")
                },1000);
      },
      ...
      return {
        ...
        rules: {
          categoryname: [
            ...
            {pattern: /^[A-Za-z0-9 _\-\ \.\&\u4e00-\u9fa5]{2,32}$/,message: this.$t('blog.snlen')}
          ],
          weight: [// ^100$|^(\d|[1-9]\d)(\.\d+)*$
